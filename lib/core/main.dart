...
void main() async {
  ...
  // Must be registered before runApp — FCM background isolate looks for this
  // top-level function by name at startup.
  FirebaseMessaging.onBackgroundMessage(firebaseMessagingBackgroundHandler);

  // Initialise FCM: request permission, fetch token, register listeners.
